...
namespace Prime31
{
	public class Facebook : P31RestKit
	{
		...
		{
			Facebook.<fetchImageAtUrl>c__Iterator1D <fetchImageAtUrl>c__Iterator1D = new Facebook.<fetchImageAtUrl>c__Iterator1D();
			<fetchImageAtUrl>c__Iterator1D.url = url;
			<fetchImageAtUrl>c__Iterator1D.completionHandler = completionHandler;
			<fetchImageAtUrl>c__Iterator1D.<$>url = url;
			<fetchImageAtUrl>c__Iterator1D.<$>completionHandler = completionHandler;
			return <fetchImageAtUrl>c__Iterator1D;
		}
