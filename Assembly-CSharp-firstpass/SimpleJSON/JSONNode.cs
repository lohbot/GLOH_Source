	...
	public class JSONNode
	{
		...
		public void SaveToCompressedStream(Stream aData)
		{
			using (BZip2OutputStream bZip2OutputStream = new BZip2OutputStream(aData))
			{
				...
				this.SaveToStream(bZip2OutputStream);
		...
		public string SaveToCompressedBase64()
		{
			...
			{
				this.SaveToCompressedStream(memoryStream);
		...
		public static JSONNode LoadFromCompressedStream(Stream aData)
		{
			...
			return JSONNode.LoadFromStream(aData2);
		}
		...
		public static JSONNode LoadFromCompressedBase64(string aBase64)
		{
			...
			return JSONNode.LoadFromCompressedStream(new MemoryStream(buffer)
			{
				Position = 0L
			});
		}
