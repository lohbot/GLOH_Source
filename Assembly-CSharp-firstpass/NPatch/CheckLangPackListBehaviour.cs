...
namespace NPatch
{
	public class CheckLangPackListBehaviour : MonoBehaviour
	{
		...
		public void CheckLangPackList(List<string> _packedList, Launcher _Owner, int _division, Queue<int> _packSizeQueue, Queue<string> _szMD5Queue, Queue<int> _zipfileSizeQueue, Action<bool> _ChangeIsNeededPatch, Queue<int> _unzipfileSizeQueue, Queue<int> _unpackSizeQueue, Queue<int> _DivisonQueue, Launcher.CheckPackListDelegate packListDelegate, Launcher.AddTaskInstall _addTaskInstall, Action _EndBehaviour)
		{
			...
			base.StartCoroutine("CheckLangPackCoroutine");
		}

		[DebuggerHidden]
		private IEnumerator CheckLangPackCoroutine()
		{
			CheckLangPackListBehaviour.<CheckLangPackCoroutine>c__IteratorC <CheckLangPackCoroutine>c__IteratorC = new CheckLangPackListBehaviour.<CheckLangPackCoroutine>c__IteratorC();
			<CheckLangPackCoroutine>c__IteratorC.<>f__this = this;
			return <CheckLangPackCoroutine>c__IteratorC;
		}
	}
}
