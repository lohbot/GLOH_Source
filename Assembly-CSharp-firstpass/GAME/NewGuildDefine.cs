...
namespace GAME
{
	public static class NewGuildDefine
	{
		...
		public enum eMY_NEWGUILD_BOSS_REWARDINFO
		{
			eNEWGUILD_MY_BOSSREWARD_STATE_NONE,
			eNEWGUILD_MY_BOSSREWARD_STATE_READY,
			eNEWGUILD_MY_PLAYSTATE_MAX
		}
		...
		public enum eNEWGUILD_GOLDENEGG_TYPE
		{
			eNEWGUILD_GOLDENEGG_TYPE_NONE,
			eNEWGUILD_GOLDENEGG_TYPE_WHITE,
			eNEWGUILD_GOLDENEGG_TYPE_GOLD
		}
		...
		public const short NEWGUILD_INVITE_ADVERTISING = 50;
