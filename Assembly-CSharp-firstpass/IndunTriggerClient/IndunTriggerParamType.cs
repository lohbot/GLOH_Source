...
{
	public class IndunTriggerParamType
	{
		public INDUN_TRIGGERKIND m_eKind;
		...
		public IndunTriggerParamType()
		{
			this.m_eKind = INDUN_TRIGGERKIND.INDUN_TRIGGERKIND_NONE;
			this.m_eParam = new PARAMTYPE[15];
			this.m_szHelp = new string[15];
		}

		public IndunTriggerParamType(string szName, INDUN_TRIGGERKIND eKind, PARAMTYPE Param1, PARAMTYPE Param2, PARAMTYPE Param3, PARAMTYPE Param4, PARAMTYPE Param5, PARAMTYPE Param6, PARAMTYPE Param7, PARAMTYPE Param8, PARAMTYPE Param9, PARAMTYPE Param10, PARAMTYPE Param11, PARAMTYPE Param12, PARAMTYPE Param13, PARAMTYPE Param14, PARAMTYPE Param15)
		{
			this.m_eKind = eKind;
			this.m_eParam = new PARAMTYPE[15];
			this.m_szHelp = new string[15];
