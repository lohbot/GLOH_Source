...
public class ExchangeJewelryDlg : Form
{
	...
	private ExchangeJewelryDlg.TYPE m_eType = ExchangeJewelryDlg.TYPE.TYPE_EXCHANGE_NEW;
	...
	{
		this.m_nlbList = (base.GetControl("newlistbox_jewelryexchange") as NewListBox);
	...
	private void Show_ExchangeList()
	{
		...
		{
			if (this.m_eType == (ExchangeJewelryDlg.TYPE)current.m_nType)
			{
	...
	private void Click_NewItemExchange(IUIObject obj)
	{
		...
		this.InitSelectItem();
		this.m_eType = ExchangeJewelryDlg.TYPE.TYPE_EXCHANGE_NEW;
		this.Show_ExchangeList();
	}
	...
	private void Click_OldItemExchange(IUIObject obj)
	{
		...
		this.InitSelectItem();
		this.m_eType = ExchangeJewelryDlg.TYPE.TYPE_EXCHANGE_OLD;
		this.Show_ExchangeList();
	}
	...
	private void ClickHelp(IUIObject obj)
	{
		...
		{
			gameHelpList_Dlg.SetViewType(eHELP_LIST.Gear_Legend.ToString());
		}
	}
