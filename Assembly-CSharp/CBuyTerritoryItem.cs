...
public class CBuyTerritoryItem : CNpcUI
{
	public CBuyTerritoryItem()
	{
		...
		string textFromInterface = NrTSingleton<NrTextMgr>.Instance.GetTextFromInterface("1542");
		...
		base.SetUIID(0, G_ID.BUY_ITEM_DLG);
