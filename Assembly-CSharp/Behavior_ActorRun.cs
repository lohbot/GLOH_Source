...
public class Behavior_ActorRun : Behavior_ActorMove
{
	...
	{
		return string.Format("{0} 캐릭터를 X:{1}, Y:{2}로 {3}초 동안 뛰도록 시킨다.", new object[]
		{
			this.m_ActorName,
	...
	{
		NrTSingleton<EventTriggerMiniDrama>.Instance.RunActor(this.m_ActorName, x, y, time);
	}
}
