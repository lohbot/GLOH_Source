...
public class CExchangeGuildWar : CNpcUI
{
	public CExchangeGuildWar()
	{
		...
		{
			string textFromInterface = NrTSingleton<NrTextMgr>.Instance.GetTextFromInterface("3065");
			...
			base.SetUIID(0, G_ID.EXCHANGE_GUILDWAR_DLG);
		}
		else
		{
