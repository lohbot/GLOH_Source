...
namespace WellFired.Shared
{
	public static class StringExtensions
	{
		...
		{
			StringExtensions.<Split>c__Iterator75 <Split>c__Iterator = new StringExtensions.<Split>c__Iterator75();
			<Split>c__Iterator.str = str;
			<Split>c__Iterator.controller = controller;
			<Split>c__Iterator.<$>str = str;
			<Split>c__Iterator.<$>controller = controller;
			StringExtensions.<Split>c__Iterator75 expr_23 = <Split>c__Iterator;
			expr_23.$PC = -2;
			return expr_23;
		}
