...
namespace GooglePlayGames.Android
{
	public class AndroidClient : IPlayGamesClient
	{
		...
		private void RetrieveUserEmail()
		{
			...
			{
				using (AndroidJavaObject @static = androidJavaClass.GetStatic<AndroidJavaObject>("AccountApi"))
				{
					this.mUserEmail = @static.Call<string>("getAccountName", new object[]
					{
						this.mGHManager.GetApiClient()
					});
					Logger.d("Player email: " + this.mUserEmail);
				}
			}
		}
	}
