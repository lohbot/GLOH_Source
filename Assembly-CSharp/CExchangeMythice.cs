...
public class CExchangeMythice : CNpcUI
{
	public CExchangeMythice()
	{
		...
		if (NrTSingleton<ContentsLimitManager>.Instance.IsExchangeMythicSol())
		{
			string textFromInterface = NrTSingleton<NrTextMgr>.Instance.GetTextFromInterface("2848");
			...
			base.SetUIID(0, G_ID.EXCHANGE_MYTHICSOL_DLG);
		}
		else
		{
