...
public class CQuestReset : CNpcUI
{
	public CQuestReset()
	{
		...
		string textFromInterface = NrTSingleton<NrTextMgr>.Instance.GetTextFromInterface("651");
		...
		this.m_kMenu[0].strIconPath = "NPC_I_QuestRs";
		...
		base.SetUIID(0, G_ID.QUEST_RESET_DLG);
